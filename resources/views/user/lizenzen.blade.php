        ...
        $(document).ready(function () {
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row) { // Aktionen (Edit / Delete)
                            return `
                                ...
                                <a class="btn btn-sm btn-danger delete-btn" data-Lizenzschluessel="${data.Lizenzschluessel}">Löschen</a>
                                <a href="/computer_einer_lizenz/{{$id}}/${data.Lizenzschluessel}" class="btn btn-sm btn-info">Zu den Computern</a>
                            `;
                        }
                    }
                ]
            ...
            $(document).on('click', '.delete-btn', function () {
                ...
                if (confirm('Sind Sie sicher, dass Sie diese Lizenz löschen wollen?')) {
                    $.ajax({
                        url: `/lizenzen/delete/${Lizenzschluessel}`,
                        type: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
