                ...
                "columns": [
                    ...
                    { "data": "Büronummer" },
                    {
                        ...
                        "render": function (data, type, row) {
                            return `
                                <a class="btn btn-sm btn-success edit-btn" data-id="${data.id}" data-pcid="${data.PCID}" data-büronummer="${data.Büronummer}">Bearbeiten</a>
                                <a class="btn btn-sm btn-danger delete-btn" data-id="${data.id}" data-PCID="${data.PCID}">Löschen</a>
                                <a href="/licenses/view/{{$id}}/${data.id}" class="btn btn-sm btn-info">Lizenzen</a>
                            `;
                        }
                    }
                ]
...
/*             $(document).on('click', '.show-btn', function (e) {
            ...
            const PCID = $(this).data('id'); // Primaerschluessel
